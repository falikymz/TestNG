...
public class C03_PositiveLoginTest {
    ...
    public void test01() {
        ...
        blueRentalPage.emailBox.sendKeys(ConfigReader.getProperty("blueRentalEmail"));
        blueRentalPage.passwordBox.sendKeys(ConfigReader.getProperty("blueRentalPassword"), Keys.ENTER);
